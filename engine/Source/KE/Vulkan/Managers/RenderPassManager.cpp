...
bool RenderPassManager::Init ()
    ...
    auto * swapChainMgr = static_cast< SwapchainManager * >( m_info->Managers.SwapchainManager.get () );
...
VkFramebuffer RenderPassManager::GetFramebuffer ( uint32_t Index ) const
    {
...
bool RenderPassManager::RecreateForSwapChain ()
    {
...
bool RenderPassManager::CreateDepthImage ()
    {
    auto * swapChainMgr = static_cast< SwapchainManager * >( m_info->Managers.SwapchainManager.get () );
...
bool RenderPassManager::CreateDepthImageView ()
    {
    auto * deviceMgr = static_cast< DeviceManager * >( m_info->Managers.DeviceManager.get () );
    VkDevice device = deviceMgr->GetDevice ();
...
const std::string & RenderPassManager::GetManagerName () const
    {
    static const std::string name = "Renderpass Manager";
    return name;
    }
...
bool RenderPassManager::CreateSwapChainResources ()
    {
...
void RenderPassManager::DestroySwapChainResources ()
    {
...
VkRenderPass RenderPassManager::CreateRenderPass ( const FRenderPassInfo & Info )
    {
    // Color attachment
    VkAttachmentDescription colorAttachment {};
...
VkFramebuffer RenderPassManager::CreateFramebuffer ( VkRenderPass RenderPass,
